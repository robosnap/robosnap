...
class Sam3VideoPredictor:
    ...
    # def pretty_print(self, obj, indent=0, max_depth=3, max_list=3, name=None):
    #     prefix = " " * indent
    #     if name is not None:
    #         prefix += f"{name}: "
    ...
    #             print(
    #                 prefix
    #                 + f"Tensor(shape={tuple(obj.shape)}, dtype={obj.dtype}, device={obj.device})"
    #             )
    #         except Exception:
    #             print(prefix + f"Tensor({type(obj)})")
    ...
    #             s = s[:120] + "..."
    #         print(prefix + s)
    # def _pretty_print_structure(self, state):
    #     print("\n========== INFERENCE STATE (DETAILED) ==========")
    #     self.pretty_print(state, max_depth=4, max_list=3)
    #     print("================================================\n")
    ...
    def _get_session(self, session_id):
        ...
        # print("----------- STATE ---------------")
        # self._pretty_print_structure(session["state"])
        # print("=================================\n")
